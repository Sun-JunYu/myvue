								  ...
								  <td data-th="Product">
									  <div class="row">
										  <div class="col-md-3 text-left">
											  <img src="../assets/images/placeholder-product.jpg" alt="" class="img-fluid">
										  </div>
  ...
  export default {
	data () {
	  return {
		msg: "这是一个变量",
		list:[
		  {id:1,name:'iphone8',price:5099,num:0},
		  {id:2,name:'iphonexs',price:8699,num:0},
		  {id:3,name:'iphonexr',price:6499,num:0},
		]
	  }
	},
	mounted:function(){
